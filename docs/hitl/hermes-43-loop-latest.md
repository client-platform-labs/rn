...
mode=afk ok=true closeReady=true at=2026-09-01T00:59:01.014Z

| ID | Kind | Status | Detail |
|----|------|--------|--------|
| Dx-1-docs | AFK | PASS | platform D0/Dx docs present |
| Dx-2-ota-check-fetch | AFK | PASS | PASS ota verify + check/fetch update_id=desk-cf45100f7a05 staged=/var/folders/zt/_qy322zn0zqbxrkw027t7ql40000gn/T/tiangong-ota-stage-74447/index.hbc |
...
| Dx-T-rename-applicationId | TRUE-HITL | SKIP/TODO | TRUE-HITL — human only (non-blocking) |
